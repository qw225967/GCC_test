...
FeedbackRtpTransportPacket::Parse(const uint8_t *data, size_t len) {
...
FeedbackRtpTransportPacket::FeedbackRtpTransportPacket(
  ...
  auto *data = reinterpret_cast<uint8_t *>(commonHeader) +
  ...
  size_t contentLen = len - Packet::CommonHeaderSize -
...
size_t FeedbackRtpTransportPacket::Serialize(uint8_t *buffer) {
  ...
  // Reference time.
  Utils::Byte::Set3Bytes(buffer, offset,
                         static_cast<uint32_t>(this->referenceTime));
  offset += 3;
...
FeedbackRtpTransportPacket::AddPacket(uint16_t sequenceNumber,
  ...
  if (!RTC::SeqManager<uint16_t>::IsSeqHigherThan(sequenceNumber,
...
FeedbackRtpTransportPacket::Chunk *
FeedbackRtpTransportPacket::Chunk::Parse(const uint8_t *data, size_t len,
                                         uint16_t count) {
...
uint16_t
FeedbackRtpTransportPacket::OneBitVectorChunk::GetReceivedStatusCount() const {
...
size_t
FeedbackRtpTransportPacket::OneBitVectorChunk::Serialize(uint8_t *buffer) {
...
uint16_t
FeedbackRtpTransportPacket::TwoBitVectorChunk::GetReceivedStatusCount() const {
...
size_t
FeedbackRtpTransportPacket::TwoBitVectorChunk::Serialize(uint8_t *buffer) {
