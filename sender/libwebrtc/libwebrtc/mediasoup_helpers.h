...
const std::vector<webrtc::rtcp::ReceivedPacket>
GetReceivedPackets(const RTC::RTCP::FeedbackRtpTransportPacket *packet) {
...
int64_t GetBaseDeltaUs(const RTC::RTCP::FeedbackRtpTransportPacket *packet,
