...
template <typename T> void SeqManager<T>::Sync(T input) {
  // Update base.
...
template <typename T> void SeqManager<T>::Drop(T input) {
...
template <typename T> void SeqManager<T>::Offset(T offset) {
  this->base += offset;
}

template <typename T> bool SeqManager<T>::Input(const T input, T &output) {
  auto base = this->base;
...
template <typename T> T SeqManager<T>::GetMaxInput() const {
  return this->maxInput;
}

template <typename T> T SeqManager<T>::GetMaxOutput() const {
